...
import RocketImg from "../Assests/Images/undraw_rocket.svg";
        ...
        <li className="nav-item">
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <Link className="collapse-item" to="/component/Component/Buttons">
                Buttons
              </Link>
              <Link className="collapse-item" to="/component/Component/cards">
                Cards
              </Link>
            </div>
          </div>
        ...
        <li className="nav-item">
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <Link className="collapse-item" to="/Pages/LoginPage">
                Login
              </Link>
              <Link className="collapse-item" to="/Pages/RegisterPage">
                Register
              </Link>
              <Link className="collapse-item" to="/Pages/ForgotPassword">
                Forgot Password
              </Link>
              <div className="collapse-divider"></div>
              <h6 className="collapse-header">Other Pages:</h6>
              <Link className="collapse-item" to="/Pages/Error404">
                404 Page
              </Link>
              <Link className="collapse-item" to="/Pages/BlankPage">
                Blank Page
              </Link>
            </div>
          </div>
